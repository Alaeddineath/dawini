    ...
    return WillPopScope(
      onWillPop: () async {
        Navigator.pushReplacementNamed(
            context, '/home-page'); // Navigating to home page
          ...
          children: [
            ...
            Positioned(
              ...
              child: FutureBuilder<List<Map<String, dynamic>>>(
                future: MedicineDB
                    .getAllMedicines(), // Fetch all medicines from the database
                builder: (BuildContext context,
                  ...
                  if (snapshot.hasError) {
                    ...
                    List<Map<String, dynamic>> medicines =
                        snapshot.data!; // Assign the data to 'medicines'
                    if (medicines.isEmpty) {
                      WidgetsBinding.instance.addPostFrameCallback((_) {
                        Navigator.of(context)
                            .pushReplacementNamed('/empty-medecines-list');
                      });
                    }
